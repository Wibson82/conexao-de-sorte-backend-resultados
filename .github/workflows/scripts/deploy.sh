...
# ============================================================================
# 🚀 SCRIPT DE DEPLOY SIMPLIFICADO - CONEXÃO DE SORTE RESULTADOS
# ============================================================================
#
...
PROJECT_DIR="/opt/conexao-de-sorte/resultados"
...
services:
  resultados:
    image: ghcr.io/\${GITHUB_REPOSITORY:-conexao-de-sorte/conexao-de-sorte-backend-resultados}-resultados:\${IMAGE_TAG}
    ports:
      - "8080:8080"
    environment:
