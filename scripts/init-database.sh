...
echo "🗄️ Inicializando database para conexao-sorte-resultados..."
...
echo "🔧 Criando database conexao_sorte_resultados se não existir..."
...
echo "✅ Database conexao_sorte_resultados criado/verificado com sucesso"
